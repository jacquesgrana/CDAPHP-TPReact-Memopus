    ...
    <div className="">
      ...
      >
        ...
        <div className="div-form-input-term form-group">
            ...
            <input className="form-control div-form-input-input-term" type="text" name="name" id="name" />
        </div>
        <div className="d-flex justify-content-center gap-3 mt-3 mb-1">
            ...
            <button className="btn btn-warning btn-sm" onClick={closeModalTerm}>Fermer</button>
        </div>
        </fetcher.Form>
      </ReactModal>
    </div>
